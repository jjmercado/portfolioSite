...
<section id="hero" class="text-center pt-24 sm:pt-24">  <!-- Hintergrund-Glow-Effekt -->
  ...
  <div class="mx-auto max-w-2xl px-4">
    <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">
      Ich erschaffe interaktive Welten als
      <span class="text-purple-400">Indie Game Developer</span>
    </h1>
...
<section id="games" class="pt-16 sm:pt-20">
...
<section id="latest-devlogs" class="content-section pt-24">
  <div class="container mx-auto px-4 max-w-4xl"> <!-- max-w-4xl für eine angenehme Breite -->
    ...
    <div class="mt-10 text-center">
      <NuxtLink to="/devlog" class="rounded-md bg-purple-600 px-4 py-3 text-base font-semibold text-white shadow-lg shadow-purple-600/20 transition-all duration-300 hover:bg-purple-500 hover:scale-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-600">
        Alle Devlogs ansehen
      </NuxtLink>
    </div>
  </div>
</section>
