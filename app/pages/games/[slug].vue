      ...
      <article class="mx-auto max-w-4xl">
        ...
        <div class="download-section my-8 text-center">
          ...
          <div class="flex justify-center gap-4">
            <NuxtLink v-if="data.meta.downloads.windows" :to="data.meta.downloads.windows" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
              Windows
            </NuxtLink>
            <NuxtLink v-if="data.meta.downloads.linux" :to="data.meta.downloads.linux" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
              Linux
            </NuxtLink>
          </div>
        </div>
