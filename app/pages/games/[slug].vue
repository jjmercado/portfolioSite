      ...
      <article class="mx-auto max-w-4xl">
        ...
        <div class="download-section my-8 text-center">
          ...
          <div class="flex justify-center gap-4">
            <NuxtLink v-if="data.meta.downloads && data.meta.downloads.windows" :href="data.meta.downloads.windows" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" external>
              Windows
            </NuxtLink>
            <NuxtLink v-if="data.meta.downloads && data.meta.downloads.linux" :href="data.meta.downloads.linux" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded" external>
              Linux
            </NuxtLink>
          </div>
        </div>
