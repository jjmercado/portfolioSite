      ...
      <article class="mx-auto max-w-4xl">
        ...
        <div class="download-section my-8 text-center">
          ...
          <div class="flex justify-center gap-4">
            <a v-if="data.downloads && data.downloads.windows" :href="data.downloads.windows" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
              Windows
            </a>
            <a v-if="data.downloads && data.downloads.linux" :href="data.downloads.linux" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
              Linux
            </a>
          </div>
        </div>
