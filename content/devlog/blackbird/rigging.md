...
description: 'So nutzen wir das Rigify Addon in Blender für Blackbird, inklusive Troubleshooting zu Face-Bones und Sockets.'
date: '2026-02-08'
project: 'Blackbird'
project_image: '/games/blackbird/images/rigging_result.png' 
---

# Das Rigging – Den Charakter zum Leben erwecken

Nachdem das Texturing abgeschlossen ist, wird es Zeit, dass sich unser Held auch bewegen kann. Für **Blackbird** setzen wir auf das mächtige **Rigify-Addon** in Blender, um ein professionelles Human-Rig zu erstellen.
...
- <NuxtImg src="/games/blackbird/images/rigging/rigify_rig_delete_face.png" alt="Delete Face Bones"/>
- <NuxtImg src="/games/blackbird/images/rigging/rig_face_del.png" alt="Deleted Face Bones"/>
...
- <NuxtImg src="/games/blackbird/images/rigging/error_when_not_upgrade_face.png" alt="Error Message"/>

- <NuxtImg src="/games/blackbird/images/rigging/hidden_face_bone.png" alt="Hidden Face Bone"/>
...
- <NuxtImg src="/games/blackbird/images/rigging/spine_not_overlapped.png" alt="Spine not overlaped"/>
- <NuxtImg src="/games/blackbird/images/rigging/spine_overlapped.png" alt="Spine is overlapping"/>
- <NuxtImg src="/games/blackbird/images/rigging/disjoint_error_message.png" alt="Disjoint Error Message"/>

---

## Custom Sockets für modulare Ausrüstung

Da Blackbird verschiedene Rüstungsteile unterstützt, habe ich das Standard-Rig um **Extra-Bones** erweitert. Diese dienen als feste **Sockets** (Ankerpunkte) für unsere Ausrüstung:
...
- <NuxtImg src="/games/blackbird/images/rigging/char_meta_rig.png" alt="Meta rig"/>
...
- <NuxtImg src="/games/blackbird/images/rigging/char_rig.png" alt="Rig"/>
