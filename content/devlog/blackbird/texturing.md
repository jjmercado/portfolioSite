...
description: 'Von grauen Modellen zu lebendigen Helden: Ein Blick auf das Texturing der Rüstung und den Einsatz von Normal Maps in Blackbird.'
date: '2026-02-05'
project: 'Blackbird'
project_image: '/games/blackbird/images/texturing_result.png' 
---
...
<NuxtImg src="/games/blackbird/images/texturing/uv_editing.png" alt="uv unwrapping"/>
...
<NuxtImg src="/games/blackbird/images/texturing/sword_normal_map.png" alt="sword normal map flat"/>

*Die Lösung (Shade Smooth):*
<NuxtImg src="/games/blackbird/images/texturing/sword_normal_map_current.png" alt="sword normal map smooth"/>

* **Color Texture (Albedo):** Hier wurde die Basis-Farbe festgelegt, um dem Schwert seinen finalen Look und Charakter zu geben.
<NuxtImg src="/games/blackbird/images/texturing/sword_color.png" alt="sword color texture"/>
...
<NuxtImg src="/games/blackbird/images/texturing/sword_metal.png" alt="sword metal texture"/>
...
<video loop autoplay src="/portfolioSite/games/blackbird/videos/sword_normalmap_result.mp4">
